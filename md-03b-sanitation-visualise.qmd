...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend?
    ...
    \# bar depicts proportion(percentage) of population (national, rural and urban) and extent sanitation access.

    \# legend depict color for each level, for instance black for basic sanitation.
